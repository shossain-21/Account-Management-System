...
namespace AccountManagementSystem.Migrations
{
    ...
    [Migration("20250611060637_Make 'Debit' and 'Credit' fields decimal in AspNetVoucherItems table")]
    partial class MakeDebitandCreditfieldsdecimalinAspNetVoucherItemstable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AccountManagementSystem.Models.Accounts.VoucherItem", b =>
                {
                    ...
                    b.HasOne("AccountManagementSystem.Models.Accounts.SubSidiary", "SubSidiary")
                        .WithMany()
                        .HasForeignKey("SubSidiaryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AccountManagementSystem.Models.Accounts.Voucher", "Voucher")
                        .WithMany()
